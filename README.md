...
1. 単純にシンボルを検索しているため、誤ったコードを生成することがあります。  
   別途、動作確認を実施ください。  
   ＜問題が出るパターン＞
   - 変数等に使用しているシンボルも、autoload の対象として判定してしまう
...
- 2017-10-14 v1.20 空行削除のみ
- 2018-7-8   v1.20 README修正のみ(Gauche v0.9.6 で動作確認)
- 2019-12-19 v1.20 テスト追加のみ(Gauche v0.9.9 で動作確認)
